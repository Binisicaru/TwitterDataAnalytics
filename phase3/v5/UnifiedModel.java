...
public class UnifiedModel {
	...
	// Logic for Query 6
//	public BigInteger extractM(String requestAnalysis) {
//		String[] requestParts = requestAnalysis.split("&");
//		String[] mParts = requestParts[0].split("=");
//		BigInteger m = new BigInteger(mParts[1]);
//		return m;
//	}
//	
//	public BigInteger extractN(String requestAnalysis) {
//		String[] requestParts = requestAnalysis.split("&");
//		String[] nParts = requestParts[1].split("=");
//		BigInteger n = new BigInteger(nParts[1]);
//		return n;
//	}
	
	public long extractM(String requestAnalysis) {
		String[] requestParts = requestAnalysis.split("&");
		String[] mParts = requestParts[0].split("=");
		long m = Long.parseLong(mParts[1]);
		return m;
	}
	
	public long extractN(String requestAnalysis) {
		String[] requestParts = requestAnalysis.split("&");
		String[] nParts = requestParts[1].split("=");
		long n = Long.parseLong(nParts[1]);
		return n;
	}
}
